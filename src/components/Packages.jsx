...
const packages = [
  ...
  // Graphics Design
  {
    ...
    tier: "Basic",
    price: "199",
    description: "Essential graphics for your brand",
    features: [
    ...
    notIncluded: ["Print Materials", "Packaging Design", "Infographics"],
  },
  {
    service: "Graphics Design",
    tier: "Standard",
    ...
    notIncluded: ["Packaging Design"],
  },
  {
    service: "Graphics Design",
    tier: "Premium",
    price: "899",
    description: "Full graphics solution",
    features: [
  ...
  // Logo Design
  {
    ...
    tier: "Basic",
    price: "149",
    description: "Simple logo for startups",
    features: [
      "3 Logo Concepts",
      "2 Revisions",
      "PNG & JPG Files",
    ...
    notIncluded: ["Vector Files", "Brand Guidelines", "Stationery Design"],
  },
  {
    service: "Logo Design",
    tier: "Standard",
    ...
    notIncluded: ["Full Brand Guidelines"],
  },
  {
    service: "Logo Design",
    tier: "Premium",
    price: "699",
    description: "Complete logo & branding",
    features: [
      "Unlimited Concepts",
      "Unlimited Revisions",
      "All File Formats",
  ...
  // Video Editing
  {
    ...
    tier: "Basic",
    price: "199",
    description: "Simple video edits",
    features: [
      "Up to 5 Min Video",
    ...
    notIncluded: ["Color Grading", "Motion Graphics", "Sound Design"],
  },
  {
    service: "Video Editing",
    tier: "Standard",
