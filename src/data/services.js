    ...
    features: [
      {
        ...
        description: "Engaging posts, stories, and reels tailored for each platform.",
        icon: "create"
      },
      {
        title: "Community Management",
        description: "Active engagement with your followers and audience.",
        icon: "community"
      },
      {
        title: "Social Advertising",
        description: "Targeted ad campaigns on Facebook, Instagram, LinkedIn, and TikTok.",
        icon: "advertising"
      },
      {
        title: "Influencer Marketing",
        description: "Partnerships with relevant influencers in your niche.",
        icon: "influencer"
      },
      {
        title: "Analytics & Insights",
        description: "Detailed reporting on engagement and growth metrics.",
        icon: "insights"
      },
      {
        title: "Strategy Development",
        description: "Custom social media strategy aligned with your goals.",
        icon: "strategy"
      }
    ],
    process: [
      { step: 1, title: "Audit", description: "Analyzing your current social presence." },
      { step: 2, title: "Strategy", description: "Developing a content and growth strategy." },
      { step: 3, title: "Content Calendar", description: "Planning and scheduling content." },
      { step: 4, title: "Creation", description: "Producing high-quality content." },
      { step: 5, title: "Engagement", description: "Active community management." },
      { step: 6, title: "Reporting", description: "Monthly analytics and insights." }
    ],
    technologies: ["Meta Business Suite", "Hootsuite", "Canva", "Later", "Sprout Social"],
    faqs: [
      { question: "Which platforms do you manage?", answer: "We manage all major platforms including Instagram, Facebook, LinkedIn, Twitter/X, TikTok, and YouTube." },
      { question: "How many posts per week?", answer: "Our standard package includes 3-5 posts per week, with options for more frequent posting." },
      { question: "Do you respond to comments and DMs?", answer: "Yes, community management including responding to comments and messages is included in our services." }
    ]
  },
  "e-commerce": {
    id: 8,
    ...
    features: [
      ...
      },
      {
        ...
        description: "Easy-to-use product catalog and inventory management.",
        icon: "product"
      },
      {
        title: "Payment Integration",
        description: "Secure payment gateways including Stripe, PayPal, and more.",
        icon: "payment"
      },
      {
        title: "Shipping Solutions",
        description: "Automated shipping calculations and carrier integration.",
        icon: "shipping"
      },
      {
        title: "Conversion Optimization",
        description: "Checkout optimization for higher conversion rates.",
        icon: "convert"
      },
      {
        title: "Analytics & Tracking",
        description: "Sales analytics and customer behavior tracking.",
        icon: "track"
      }
    ],
    process: [
      { step: 1, title: "Requirements", description: "Understanding your products and business model." },
      { step: 2, title: "Platform Selection", description: "Choosing the right e-commerce platform." },
      { step: 3, title: "Design", description: "Creating a branded, conversion-focused design." },
      { step: 4, title: "Development", description: "Building and configuring your store." },
      { step: 5, title: "Testing", description: "Thorough testing of all functionality." },
      { step: 6, title: "Launch", description: "Going live and post-launch support." }
    ],
    technologies: ["Shopify", "WooCommerce", "Magento", "Stripe", "PayPal", "Klaviyo"],
    faqs: [
      { question: "Which platform should I choose?", answer: "It depends on your needs. Shopify is great for simplicity, WooCommerce for flexibility, and custom solutions for unique requirements." },
      { question: "Can you migrate my existing store?", answer: "Yes, we handle full migrations including products, customers, and order history." },
      { question: "Do you provide ongoing support?", answer: "Yes, we offer maintenance packages for updates, security, and feature additions." }
    ]
  }
};
...
export const getServicePackages = (serviceName) => {
  ...
  return serviceToPackageMap[serviceName] || serviceName;
};
